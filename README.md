...
My application allows users of Spotify a place to import their recently played songs using the Spotify API. From their it can display all users, allows for users to make song suggestions and allows users to query which songs have been listened to by users by specific artists.


ALL ROUTES
http://localhost:5000/ -> base.html
http://localhost:5000/names -> name_example.html
http://localhost:5000/artistsearch -> artist_search.html
http://localhost:5000/artistsearchresults -> artist_results.html
http://localhost:5000/suggestions -> suggestions.html
